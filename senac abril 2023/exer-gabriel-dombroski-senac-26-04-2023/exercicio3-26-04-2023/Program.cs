...
namespace exercicio3_26_04_2023
{
    class Program
    {
        static string[,] cadastroCorrentista = new string[1, 4];
        static int i = 0;
        ...
        static void ConsultarCadastro(ref string[,] array)
        {
            ...
            for (int j = 0; j <= i; j++)
            {
                ...
                {
                    Console.WriteLine($"CPF: {array[j, 0]} - Nome: {array[j, 1]} - Sobrenome: {array[j, 2]} - Renda Comprovada: R${array[j, 3]}");
        ...
        static void ExcluirCadastro(ref string[,] array)
        {
            int validador = 0;
            long excluir;
            string[,] arrayTemp = new string[i + 1, 4];
            int k = 0, l = 0;
        ...
        static void ExibirCadastros(ref string[,] array)
        {
            ...
            for (int j = 0; j <= i; j++)
            {
                if (array[j,0] != "")
                {
                    Console.WriteLine($"Cadastro Nº{c}: CPF: {array[j, 0]} - Nome: {array[j, 1]} - Sobrenome: {array[j, 2]} - Renda Comprovada: R${array[j, 3]}");
                    Console.WriteLine("");
