...
namespace exercicios2_20_04_2023
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            string[,] trabalhadorAp = new string[nTrabalhadoresAp, 4];
            ...
            for (int i = 0; i < nTrabalhadoresAp; i++) {
                ...
                if (Byte.Parse(trabalhadorAp[i, 1]) >= 65)
                {
                    trabalhadorAp[i, 3] = "Sim";
                }
                else if (Byte.Parse(trabalhadorAp[i, 2]) >= 35)
                {
                    trabalhadorAp[i, 3] = "Sim";
                }
                else if (Byte.Parse(trabalhadorAp[i, 1]) >= 60 && Byte.Parse(trabalhadorAp[i, 2]) >= 25)
                {
                    trabalhadorAp[i, 3] = "Sim";
                }
                else
                {
                    trabalhadorAp[i, 3] = "Não";
                }
            }
            ...
            for (int i = 0; i < nTrabalhadoresAp; i++) {
                if (maiorNome < trabalhadorAp[i, 0].Length)
                {
                    maiorNome = trabalhadorAp[i, 0].Length;
                }
                if (maiorIdade < $"{trabalhadorAp[i, 1]} anos".Length)
                {
                    maiorIdade = $"{trabalhadorAp[i, 1]} anos".Length;
                }
                if (maiorCont < $"{trabalhadorAp[i, 2]} anos".Length)
                {
                    maiorCont = $"{trabalhadorAp[i, 2]} anos".Length;
                }
            }
            ...
            for (int i = 0; i < nTrabalhadoresAp; i++) {
                ...
                //Alinhando os Nomes
                if (trabalhadorAp[i, 0].Length < maiorNome)
                {
                    nEspacos1 = (maiorNome - trabalhadorAp[i, 0].Length) + 5;
                }
                Console.Write($"{trabalhadorAp[i, 0]}");
                for (int c = 0; c < nEspacos1; c ++) {
                    Console.Write(" ");
                }

                //Alinhando as Idades
                if ($"{trabalhadorAp[i, 1]} anos".Length < maiorIdade)
                {
                    nEspacos2 = (maiorIdade - $"{trabalhadorAp[i, 1]} anos".Length) + 5;
                }
                Console.Write($"{trabalhadorAp[i, 1]} anos");
                for (int c = 0; c < nEspacos2; c++) {
                    Console.Write(" ");
                }

                //Alinhando o Tempo de Contribuição
                if ($"{trabalhadorAp[i, 2]} anos".Length < maiorCont)
                {
                    nEspacos3 = (maiorCont - $"{trabalhadorAp[i, 2]} anos".Length) + 5;
                }
                Console.Write($"{trabalhadorAp[i, 2]} anos");
                ...
                Console.WriteLine($"{trabalhadorAp[i, 3]}     ");
            }
