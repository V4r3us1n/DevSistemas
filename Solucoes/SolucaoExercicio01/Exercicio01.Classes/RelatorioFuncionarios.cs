    ...
    public class RelatorioFuncionarios
    {
        ...
        public void RelatorioDeFuncionarios(Funcionario[] funcionarios)
        {
            for (int i = 0; i < funcionarios.Length; i++)
            {
                ...
                Console.WriteLine($"ID Funcionário: {funcionarios[i].IdFuncionario}");
                if (funcionarios[i].CNPJ != null)
                {
                ...
                Console.WriteLine($"Salário: R${funcionarios[i].Salario.ToString("F")}");
        ...
        public void RelatorioTotalSalario(Funcionario[] funcionarios)
        {
            ...
            Console.WriteLine("=====================================");
            Console.WriteLine($"Total Salário: R${TotalSalario.ToString("F")}");
            Console.WriteLine("=====================================");
            Console.WriteLine("");
        }
    }
