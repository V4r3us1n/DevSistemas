    ...
    class Program
    {
            ...
            do {
                ...
                do {
                    ...
                    try
                    {
                        ...
                        {
                            throw new NumeroNegativoException("[ERRO!] Número da Residência Não pode ser Negativo!");
                        }
                    }
        ...
        static bool ValidarCNPJ(string idFuncionario)
        {
            ...
            try {
                ...
                {
                    cnpjValido = false;
                    throw new TamanhoIncorretoException("[ERRO!] O CNPJ inserido não possui tamanho válido!");
                }
                else
                {
            ...
            catch (TamanhoIncorretoException ex)
            {
                Console.WriteLine(ex.Message);
            }
        ...
        static bool ValidarCPF(string idFuncionario)
        {
            ...
            try {
                ...
                {
                    cpfValido = false;
                    throw new TamanhoIncorretoException("[ERRO!] O CPF inserido não possui tamanho válido!");
                }
                else
                {
                    for (int i = 0; i < idFuncionario.Length; i++)
